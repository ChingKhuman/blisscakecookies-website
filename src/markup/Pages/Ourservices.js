								...
								<div className="col-lg-3 col-md-6 col-sm-6 m-b30">
									<div className="icon-bx-wraper bx-style-1 bg-white p-a30 center fly-box-ho">
										...
										<div className="icon-content">
											...
											<p>On your time fast dilivery with fresh item</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-md-6 col-sm-6 m-b30">
									<div className="icon-bx-wraper bx-style-1 bg-white p-a30 center fly-box-ho">
										...
										<div className="icon-content">
											...
											<p>Ready to pick up your Store.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-md-6 col-sm-6 m-b30">
									<div className="icon-bx-wraper bx-style-1 bg-white p-a30 center fly-box-ho">
										...
										<div className="icon-content">
											...
											<p>Reservation Booking available in specific time.</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-md-6 col-sm-6 m-b30">
									<div className="icon-bx-wraper bx-style-1 bg-white p-a30 center fly-box-ho">
										...
										<div className="icon-content">
											...
											<p>Multiple option supply so no worry</p>
										</div>
									</div>
								</div>
								<div className="col-lg-3 col-md-6 col-sm-6 m-b30">
									...
									<div className="row p-l30">
										<div className="col-lg-6 col-sm-6 m-b30">
											<div className="icon-bx-wraper text-white service-box2">
												...
												<div className="icon-content">
													<Link to="" > <h5 className="dlab-tilte">Pancakes</h5>
													</Link>
