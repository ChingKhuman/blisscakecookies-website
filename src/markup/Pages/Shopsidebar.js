                      ...
                      <div id="categories" className="acod-body collapse show">
                        <div className="acod-content">
                          <div className="widget_services">
                            <ul>
                              <li>
                                <Link to={"/shop-cart"}>Veggie Supreme</Link>
                              </li>
                              <li>
                                <Link to={"/shop-cart"}>The Funghi</Link>
                              </li>
                              <li>
                                <Link to={"/shop-cart"}>Duck Prosciutto</Link>
                              </li>
                              <li>
                                <Link to={"/shop-cart"}>Grilled Sausage</Link>
                              </li>
                              <li>
                                <Link to={"/shop-cart"}>Burger</Link>
                              </li>
                              <li>
                                <Link to={"/shop-cart"}>Brisket Onion</Link>
                              </li>
                            </ul>
                          </div>
                        </div>
                      ...
                      <div id="quantity" className="acod-body collapse show">
                        <div className="acod-content">
                          ...
                          >
                            ...
                            <label className="btn active">
                              <input name="options " id="qty2" type="radio" />{" "}
                              02
                            </label>
                            <label className="btn">
                            ...
                            <label className="btn">
                              <input name="options " id="qty5" type="radio" />{" "}
                              05
                            </label>
                            <label className="btn">
